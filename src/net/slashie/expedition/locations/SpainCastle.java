	...
	class KingsChat extends Unleasher {
		...
		private void interactWithKings(AbstractLevel level) {
			...
			if (!exp.getFlag("MET_WITH_KINGS")){
				...
				switch (choice){
				case 0:
					m(ferdinandSays()+"We will outfit the ships with sailors, officers and carpenters, we will also grant you 23.500 royal maraved�es and supplies for a five months voyage.");
					break;
				case 1:
					m(ferdinandSays()+"We will outfit the ships with crew and will assign ten soldiers to your expedition, we will also grant you 10.000 royal maraved�es and supplies for a four months voyage.");
					break;
				}
				...
				if (choice == 2){
					...
					while (choice == -1){
						choice = (UserInterface.getUI()).switchChat("Audience with the King and Queen","How much would you need?",
								"By my accounts, I need 111.650 Maraved�es.",
								"70.000 Maraved�es will be more than enough",
								"40.000 Maraved�es, and your blessing."
								);
					}
					switch (choice){
					case 0:
						m(isabellaSays()+"Then, we trust 111.650 royal maraved�es in you, and we hope you use your best judgment to outfit the expedition.");
						exp.setAccountedGold(111650);
						break;
					case 1:
						m(isabellaSays()+"Then, we trust 70.000 royal maraved�es in you, and we hope you use your best judgment to outfit the expedition.");
						exp.setAccountedGold(70000);
						break;
					case 2:
						m(ferdinandSays()+"Are you sure? You are a brave explorer. We trust 40.000 royal maraved�es in you, and we hope you use your best judgment to outfit the expedition.");
				...
				if (earnedTitle) {
					...
					m(ferdinandSays()+"Take "+exp.getTitle().getPrize()+" maraved�es from the royal treasure, and continue defending our flag in the new world.");					
		...
		private String isabellaSays() {
			return "Isabella, Queen of Castile and Le�n says: XXX XXX ";
		}

		private String ferdinandSays() {
			return "Ferdinand II, King of Arag�n says: XXX XXX " ;
		}

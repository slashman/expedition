	...
	public static ExpeditionItem[] getItemDefinitions(AppearanceFactory appFactory){
		return new ExpeditionItem[]{
			...
			new ExpeditionUnit("ROGUE",  "Rogue",  "Rogues", "Survival Wolf", UNIT_WEIGHT, 250,
					...
					85,15,
					1,
					new String[]{"STEEL_SWORD","OBSIDIAN_SWORD","STEEL_SPEAR","WOODEN_MACE"},
					new String[]{""}, 30, 50),
			new ExpeditionUnit("MARINE", "Marine", "Marines", "Trained Sea Soldier",UNIT_WEIGHT, 250,
					...
					90,5,
					2,
					new String[]{"HARQUEBUS","WOODEN_CROSSBOW","STEEL_SWORD","OBSIDIAN_SWORD", "STEEL_SPEAR","WOODEN_MACE"},
			...
			new ExpeditionUnit("SOLDIER", "Soldier", "Soldiers", "Man-at-arms", UNIT_WEIGHT, 200,
					...
					95,5,
					2,
					new String[]{"STEEL_SWORD", "HARQUEBUS", "OBSIDIAN_SWORD", "STEEL_SPEAR", "WOODEN_MACE"},
			...
			new ExpeditionUnit("ARCHER", "Archer","Archers", "Skilled with bow weapons", UNIT_WEIGHT, 200,
					...
					70,10,
					2,
					new String[]{"WOODEN_CROSSBOW", "PLUMED_BOW", "COMPOSITE_BOW", "SIMPLE_BOW", "STEEL_SPEAR","WOODEN_MACE"},
			...
			new ExpeditionUnit("CAPTAIN", "Captain","Captains", "Leads a Ship", UNIT_WEIGHT, 200,
					...
					50,5,
					3,
					new String[]{"HARQUEBUS", "STEEL_SWORD", "OBSIDIAN_SWORD", "STEEL_SPEAR","WOODEN_MACE"},
			...
			new ExpeditionUnit("NATIVE_WARRIOR", "Warrior","Warriors", "Defender of his tribe", UNIT_WEIGHT, 200, 
					...
					80,15,
					1,
					new String[]{"WOODEN_MACE", "STEEL_SPEAR"},
					new String[]{""}, 200, 100),
			new ExpeditionUnit("NATIVE_ARCHER", "Archer","Archers", "Able with the bow", UNIT_WEIGHT, 200,
					...
					60,10,
					1,
					new String[]{"SIMPLE_BOW", "WOODEN_MACE", "COMPOSITE_BOW"},
					new String[]{""}, 200, 100),
			...
			new ExpeditionUnit("EAGLE_WARRIOR", "Eagle Warrior","Eagle Warriors", "Elite Warrior", UNIT_WEIGHT, 200,
					...
					95,20,
					2,
					new String[]{"STEEL_SWORD", "OBSIDIAN_SWORD", "WOODEN_MACE", "STEEL_SPEAR"},
					new String[]{}, 200, 200),

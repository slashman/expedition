...
public class GFXAppearances {
	...
	public static GFXAppearance[] getGFXAppearances(){
		...
		return new GFXAppearance[]{
				...
				createAppearance("SAILOR", 1 ,11),
				createAppearance("ROGUE", 2 ,11),
				createAppearance("MARINE", 3 ,11),
				createAppearance("SOLDIER", 4 ,11),
				createAppearance("ARCHER", 5 ,11),
				createAppearance("CAPTAIN", 6 ,11),
				createAppearance("EXPLORER", 7 ,11),
				createAppearance("CARPENTER", 9 ,11),
				createAppearance("COLONIST", 10 ,11),
				
				createAppearance("NATIVE_WARRIOR", 1 ,12),
				createAppearance("NATIVE_BRAVE", 2 ,12),
				createAppearance("NATIVE_ARCHER", 3 ,12),

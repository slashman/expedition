...
public class FriarTutorial {
	...
	public static String[] getTextArray(int moment){
		if (moment == AFTER_TALK_KING){
			String[] ret = {"Go south (press down key) to abandon the castle and go to town."};
			return ret;
		}else if (moment == ENTERING_TOWN){
			String[] ret = {"Enter the houses with signs in order to buy things and hire people for your expedition.", 
							"You will need at least supplies for 30 days in order to cross the sea."};
			return ret;
		}else if (moment == LEAVING_TOWN){
			String[] ret = {"Listen to me carefully if you want to survive.", 
			...
			String[] ret = {"You are approaching land, put your ships near to the shore and drop anchors ",
			...
			String[] ret = {"Look for a nice place for your first town, you can use it as your base ",
